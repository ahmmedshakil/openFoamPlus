...
int main(int argc, char *argv[])
{
    ...
    // SquareMatrix<complex(Real, Real)>
    #if (0 | RUNALL)
    {
        horizontalLine();
    ...
    #if (0 | RUNALL)
    {
        ...
        Info<< "### Tall-skinny QR decomposition:" << nl;

        // Benson, A. R., Gleich, D. F., & Demmel, J. (2013, October).
        // Direct QR factorizations for tall-and-skinny matrices in MapReduce
        // architectures. In 2013 IEEE international conference on big data
        // (pp. 264-272). IEEE.
        // arXiv: 1301.1071v1
        //
        // Demmel, J., Grigori, L., Hoemmen, M., & Langou, J. (2012).
        // Communication-optimal parallel and sequential QR and LU
        // factorizations. SIAM Journal on Scientific Computing, 34(1), 206-239. 
        // doi: 10.1137/08073199
        //
